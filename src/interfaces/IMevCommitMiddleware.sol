...
import { IRegistry } from "../symbiotic/IRegistry.sol";
...
interface IMevCommitMiddleware {
    ...
    function requestOperatorDeregistrations(
        address[] calldata operators
    ) external;

    /// @notice Deregisters multiple operators.
    function deregisterOperators(
        address[] calldata operators
    ) external;

    /// @notice Blacklists multiple operators.
    function blacklistOperators(
        address[] calldata operators
    ) external;

    /// @notice Unblacklists multiple operators.
    function unblacklistOperators(
        address[] calldata operators
    ) external;
    ...
    function requestVaultDeregistrations(
        address[] calldata vaults
    ) external;

    /// @notice Deregisters multiple vaults.
    function deregisterVaults(
        address[] calldata vaults
    ) external;
    ...
    function requestValDeregistrations(
    ...
    function setSlashPeriodSeconds(
        uint256 slashPeriodSeconds_
    ) external;

    /// @notice Sets the slash oracle address.
    function setSlashOracle(
        address slashOracle_
    ) external;
    ...
    function pubkeyAtPositionInValset(
        uint256 index,
        address vault,
        address operator
