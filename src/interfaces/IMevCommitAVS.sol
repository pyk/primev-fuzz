...
import { IAVSDirectory } from "../eigen/IAVSDirectory.sol";
import { IDelegationManager } from "../eigen/IDelegationManager.sol";
import { IEigenPodManager } from "../eigen/IEigenPodManager.sol";
import { ISignatureUtils } from "../eigen/ISignatureUtils.sol";
import { IStrategyManager } from "../eigen/IStrategyManager.sol";
...
interface IMevCommitAVS {
    ...
    function requestOperatorDeregistration(
        address operator
    ) external;
    ...
    function registerLSTRestaker(
        bytes[] calldata chosenValidators
    ) external;
    ...
    function setLstRestakerDeregPeriodBlocks(
