...
interface IVanillaRegistry {
    ...
    event StakeWithdrawn(
        address indexed msgSender, address indexed withdrawalAddress, bytes valBLSPubKey, uint256 amount
    );
    ...
    function setUnstakePeriodBlocks(
        uint256 newUnstakePeriodBlocks
    ) external;
